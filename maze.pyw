...
#Above is a shebang ^ she makes sure this is run by the right py version
import pygame
...
def reset():
    ...
    abs_x = x = 1           # abs_x and abs_y point to where we are overall
    abs_y = y = 14           # x and y point to where we are in the scrren
